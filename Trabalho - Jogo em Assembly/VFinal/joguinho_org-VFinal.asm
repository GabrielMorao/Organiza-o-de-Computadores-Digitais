;Trabalho de Organização de Computadores Digitais
;----------------------------------------------------
;Gabriel Muniz Morão, NºUSP 7236785
;Juliana Yendo, NºUSP 9597020
;Stella Granatto Justo, NºUSP 9558882
;----------------------------------------------------
; ------- TABELA DE CORES -------
...
MoveFlecha_RecalculaPos:
	...
	load R0, posFlecha	; Testa se o Flecha Pegou no Balão
	inc R0
	load R1, posBalao
	loadn R2, #40
	sub R1, R1, R2
